...
<body
	...
	<!-- Div cachée contenant le lien vers la page eventJSON -->
			...
			<aside class="span2" role="complementary">
				<div class="menu-gauche" id="contact">
					...
					<c:forEach var="utilisateurs" items="${utilisateurs}">
						<form method="post"
							action="calendrierProG?name=${utilisateurs.name}">
				...
				<div class="contenu-principal">
					<div class="spanGlobal">
						<div class="spanArticle">
							...
							<a href="ajouterEvenement">Ajouter un évènement</a>&nbsp;&nbsp; <a
								href="listerEvenement">Modifier un évènement</a>
