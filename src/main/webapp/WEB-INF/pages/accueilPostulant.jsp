...
Il doit également négocier, suivre et améliorer les partenariats, prendre des décisions et en informer les membres.
									...
									<div class="organigrame" id="vicepresident"
										...
										<div class="preview"
											...
											<img src="images/vice president.png" alt="">Vice
											président
										</div>
									</div>
									<div class="organigrame" id="responsable commercial"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 70px; background-color: white; padding: 10px;">
											<img src="images/responsable commercial.png" alt="">Responsable
											Commercial
										</div>
									</div>
									...
									<div class="organigrame" id="secretaire generale"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 70px; background-color: white; padding: 10px;">
											<img src="images/secretaire generale.png" alt="">Secrétaire
											Général
										</div>
									</div>
									<div class="organigrame" id="charges de qualite1"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/charges de qualite1.png" alt="">Chargés
											de Qualité
										</div>
									</div>
									<div class="organigrame" id="charges de qualite2"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/charges de qualite2.png" alt="">Chargés
											de Qualité
										</div>
									</div>
									<div class="organigrame" id="charges de qualite3"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/charges de qualite3.png" alt="">Chargés
											de Qualité
										</div>
									</div>
									<div class="organigrame" id="charges de mission"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/charges de mission1.png" alt=""> <img
												src="images/charges de mission2.png" alt="">Chargés de
											Missions
										</div>
									</div>
									<div class="organigrame" id="DSI"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/DSI.png" alt="">Directeur des Systèmes
											d'Information
										</div>
									</div>
									<div class="organigrame" id="responsable communication interne"
										...
										<div class="preview"
											...
											<img src="images/responsable communication interne.png"
												alt="">Responsable Communication Interne
										</div>
									</div>
									<div class="organigrame" id="responsable communication externe"
										...
										<div class="preview"
											...
											<img src="images/responsable communication externe.png"
												alt="">Responsable Communication Externe
										</div>
									</div>
									<div class="organigrame" id="responsable departement inge"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/responsable departement inge.png" alt="">responsable
											de departement inge
										</div>
									</div>
									<div class="organigrame" id="responsable departement iti"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/responsable departement iti.png" alt="">responsable
											de departement iti
										</div>
									</div>
									<div class="organigrame" id="charges d'affaire"
										...
										<div class="preview"
											style="display: none; position: absolute; top: 50px; background-color: white; padding: 10px;">
											<img src="images/charges d'affaire1.png" alt=""> <img
												src="images/charges d'affaire2.png" alt=""> <img
												src="images/charges d'affaire3.png" alt=""> <img
												src="images/charges d'affaire4.png" alt=""> <img
												src="images/charges d'affaire5.png" alt=""> <img
												src="images/charges d'affaire6.png" alt="">charges
											d'affaire
										</div>
									</div>
